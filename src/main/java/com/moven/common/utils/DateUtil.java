...
public class DateUtil {
     ...
     * @return
     */
    public static String getTimeConsume(String receivedate, String opdate, String format) {
        try {
            String timeconsume = "";
            long time = DateUtil.parseStringToDate(opdate, format).getTime() - DateUtil.parseStringToDate(receivedate, format).getTime();
            if (0 == time) {
    ...
    public static void main(String[] args) {
        long l = DateUtil.getTimeConsumeByLong(DateUtil.getCurrentDateStr(DateUtil.C_YYYYMMDDHHMM), "201608231730", DateUtil.C_YYYYMMDDHHMM);
